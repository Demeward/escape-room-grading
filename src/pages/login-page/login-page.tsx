  ...
  return (
    <main className="decorated-page login">
      <div className="decorated-page__decor" aria-hidden="true">
        <picture>
          <source type="image/webp" srcSet="/public/img/content/maniac/maniac-size-m.webp, /public/img/content/maniac/maniac-size-m@2x.webp 2x" /><img src="/public/img/content/maniac/maniac-size-m.jpg" srcSet="/public/img/content/maniac/maniac-size-m@2x.jpg 2x" width="1366" height="768" alt="" />
        </picture>
      </div>
